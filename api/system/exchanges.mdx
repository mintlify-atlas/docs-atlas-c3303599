...
<ResponseField name="message" type="string">
  Status message (implementation pending in collector service)
</ResponseField>

<Warning>
This endpoint is a placeholder. Worker status tracking needs to be implemented in the collector service to return detailed worker metrics.
</Warning>
